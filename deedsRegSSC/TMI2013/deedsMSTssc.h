...
#include "niftiIO.h"							//文件读写的头文件，包括各种格式文件的转换						
...
//	srand (time(0) );
	...
	RAND_SAMPLES=randsamp2;	  //随机优化，每个Node所包含的点数
	...
	readNifti(fixedin,im1b,M,N,O,K,header);		  //读入文件-->参考图像
	readNifti(movingin,im1,M,N,O,K,header);		  //读入文件-->浮动图像
	...
	float *warped2=new float[m*n*o];			//设置图像矩阵（一维）
	...
	int m2,n2,o2,sz2;
	int m1,n1,o1,sz1;
	m2=m/grid_step[0]; n2=n/grid_step[0]; o2=o/grid_step[0]; sz2=m2*n2*o2;				 //降采样
	...
	for(int level=0;level<maxlevel;level++){
        ...
        /*
         ...
         diffeomorphic(u1i,v1i,w1i,m1,n1,o1,4,step1);								   如果是TMI2013年的文章，就用symmetric和diffeomorphic方法来处理形变场
        ...
        //consistent mapping according to the MICCAI 2013 paper						   如果是MICCAI2013的文章，就用consistent mapping方法来处理
