...
int deeds(char* fixedin,char* movingin,char* movingsegin,char* outputstem,int randsamp2,float alpha,int maxlevel,int* grid_step,int* label_hw,int* label_quant,bool segment,bool symmetric) {
