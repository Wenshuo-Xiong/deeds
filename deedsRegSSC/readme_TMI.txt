...
by Mattias P. Heinrich, Bartlomiej W. Papież, Julia A. Schnabel, Heinz Handels
 ...
 - WBIR 2014, LNCS 8454, Springer, pp 51-61
...
Medical Image Computing and Computer-Assisted Intervention - MICCAI 2013, LNCS 8149, Springer
 ...
 You should give three filenames (only plain nifti format is supported) as input

 input_vol1.nii input_vol2.nii output_vol (no .nii for output), see help (-h) for details.
